...
mp_obj_t mpy_init(mp_obj_fun_bc_t *self, size_t n_args, size_t n_kw, mp_obj_t *args) {
    ...
    MP_OBJ_TYPE_SET_SLOT(&btree_type, print, btree_print);
    MP_OBJ_TYPE_SET_SLOT(&btree_type, getiter, btree_getiter);
    MP_OBJ_TYPE_SET_SLOT(&btree_type, iternext, btree_iternext);
    MP_OBJ_TYPE_SET_SLOT(&btree_type, binary_op, btree_binary_op);
    MP_OBJ_TYPE_SET_SLOT(&btree_type, subscr, btree_subscr);
    ...
    MP_OBJ_TYPE_SET_SLOT(&btree_type, locals_dict, (void*)&btree_locals_dict);
