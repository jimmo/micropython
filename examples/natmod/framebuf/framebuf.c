...
mp_obj_t mpy_init(mp_obj_fun_bc_t *self, size_t n_args, size_t n_kw, mp_obj_t *args) {
    ...
    MP_OBJ_TYPE_SET_SLOT(&mp_type_framebuf, make_new, framebuf_make_new);
    MP_OBJ_TYPE_SET_SLOT(&mp_type_framebuf, buffer_p.get_buffer, framebuf_get_buffer);
    ...
    MP_OBJ_TYPE_SET_SLOT(&mp_type_framebuf, locals_dict, (void*)&framebuf_locals_dict);
