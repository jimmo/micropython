...
abstractions of common pulse counting applications.
...
.. method:: PCNT.init(*, ...)
    ...
    (Re-)initialise a pulse counter unit. Supported keyword arguments are:
      ...
      - ``reset``: if ``True``, reset the counter value
    ...
    single counter unit::
        ...
        rotary = PCNT(0, minimum=-32000, maximum=32000)
...
.. method:: PCNT.value([reset])
    ...
    so it is possible for a pulse to be missed.
