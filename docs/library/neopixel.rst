...
This module provides a driver for WS2818 / NeoPixel LEDs, and other LEDs based
on a similar pulse-width-modulated asynchronous serial protocol.
...
The following example draws a red gradient on a 32-pixel strip connected to pin
X8 on a pyboard::
