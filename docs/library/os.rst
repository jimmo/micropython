...
This module contains functions for filesystem access and mounting, terminal
...
.. function:: uname()
    ...
    .. note:: In general it is preferrable to use :data:`sys.platform`,
            :data:`sys.implementation`, :data:`sys.version` and the
            :mod:`platform` module. to obtain this information (and more).
...
.. function:: ilistdir([dir])
    ...
    .. admonition:: Difference to CPython
        ...
        This is a MicroPython extension, and for the common case of
        iterating a directory's contents, it avoids the allocation of the list and
        tuple elements that :func:`listdir` would create.

.. function:: listdir([dir])

    With no argument, list the current directory.  Otherwise list the given directory.

    Not supported on all ports, use :func:`ilistdir` instead.
...
.. class:: VfsLfs1(block_dev, readsize=32, progsize=32, lookahead=32)
    ...
    See :ref:`guides_software_filesystem` for more information.
...
See :ref:`guides_software_filesystem` for example implementations of block
devices using the two variants of the block protocol described below.
