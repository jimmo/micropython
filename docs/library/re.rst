...
This module implements regular expression operations. The regular expression
syntax supported is a subset of CPython's :mod:`python:re` module (and actually
...
.. function:: sub(regex_str, replace, string, count=0, flags=0, /)
    ...
    *replace* can be a string or a function.  If it is a string then escape
    ...
    Note: availability of this function depends on :term:`port`.

.. data:: DEBUG

    Flag value, display debug information about compiled expression.
    (Availability depends on :term:`port`.)
...
.. method:: match.groups()
    ...
    Note: availability of this method depends on :term:`port`.
...
.. method:: match.start([index])
    ...
    Note: availability of these methods depends on :term:`port`.
