.. _guides_implementation_optimisations:
...
.. note::
    :ref:`guides_implementation_qstr` and :ref:`guides_implementation_maps` details
    other optimizations on strings and dictionaries.
