...
.. note::
    ...
    See :ref:`guides_extending` for details on implementing an external module.
    For details on port-specific modules, see :ref:`guides_porting`.
...
An example is the ``gc`` module discussed in :ref:`guides_implementation_memorymanagement`.
