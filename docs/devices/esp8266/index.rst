...
.. figure:: img/adafruit_products_pinoutstop.jpg
...
as many boards/modules as possible, but there may be limitations. The Adafruit
...
* GPIO pin numbering is based on ESP8266 chip numbering, not the "logical"
...
The ESP8266 does not support USB, however many ESP8266-based boards include
a USB-to-UART adaptor that makes the board appear as a serial port on your
PC, which enables access to the MicroPython REPL. Other boards will require
the use of an external adaptor to communicate.
...
See :ref:`guides_connectivity_ssl_axtls`.
