...
def argparse_mount():
    ...
    _bool_flag(cmd_parser, "unsafe-links", "l", False, "follow symbolic links pointing outside of local directory")
...
def argparse_filesystem():
    ...
    _bool_flag(cmd_parser, "verbose", "v", None, "enable verbose output (defaults to True for all commands except cat)")
